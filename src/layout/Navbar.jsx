                  ...
                  {({ isActive }) => (
                    <div
                      className={`flex items-center justify-center gap-1 py-2 px-3 mx-1 rounded-lg transition-all duration-200 ${
                        isActive
                          ? "bg-[#0965fe] dark:bg-[#0965fe] text-white dark:text-white shadow-lg transform scale-105"
                          : "text-gray-500 dark:text-gray-400 hover:bg-[#508eeb] dark:hover:bg-gray-800 hover:text-[#508eeb] dark:hover:text-purple-300"
                      }`}
                    >
